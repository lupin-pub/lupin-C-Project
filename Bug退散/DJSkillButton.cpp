...
bool DJSkillButton::init()
{
	...
	//正常显示按钮
	m_normalskill = MenuItemImage::create("GameScene/NormalSkill.png", "GameScene/NormalSkill.png", CC_CALLBACK_1(DJSkillButton::norskillClickCallBack, this));
	m_normalskill->setPosition(Vec2(120, 100));


    m_SkillOne = MenuItemImage::create("GameItem\DJ\SkillFirst", "GameItem\DJ\SkillFirst", CC_CALLBACK_1(DJSkillButton::skillOneClickCallBack, this));
	m_SkillOne->setPosition(Vec2(80, 150));

	m_SkillTwo = MenuItemImage::create("GameItem\DJ\SkillSecond", "GameItem\DJ\SkillSecond", CC_CALLBACK_1(DJSkillButton::skillTwoClickCallBack, this));		
	m_SkillTwo->setPosition(Vec2(100, 100));

	m_SkillThree = MenuItemImage::create("GameItem\DJ\SkillThird", "GameItem\DJ\SkillThird", CC_CALLBACK_1(DJSkillButton::skillThreeClickCallBack, this));
...
{
	auto skillbutton = new DJSkillButton();
...
void DJSkillButton::setnorSkillAttribute() {
	addAttact = 500;
	addarmor = 0;
	addRunSpeed = 0;
}
void DJSkillButton::setSkillOneAttribute() {
	addAttact = 500;
	addarmor = 0;
	addRunSpeed = 0;
}
void DJSkillButton::setSkillTwoAttribute() {
	addAttact = 500;
	addarmor = 0;
	addRunSpeed = 0;
}
void DJSkillButton::setSkillThreeAttribute() {
	addAttact = 500;
	addarmor = 0;
	addRunSpeed = 0;
}
