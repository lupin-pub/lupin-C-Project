...
{
	if (instance == NULL)
		instance = new GameManager();//创建一个实例
	return instance;
}
...
{
	instance->monsterBlueVector.clear();
	instance->monsterRedVector.clear();
	instance->towerBlueVector.clear();
	instance->towerRedVector.clear();
